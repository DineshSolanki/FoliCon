...
function EnsureCrowdinCliIsInstalled {
    try {
        ...
        Write-Output "Crowdin CLI is installed: $crowdinVersion"
    } catch {
        Write-Output "Installing Crowdin CLI..."
...
function SetEnvironmentVariables {
    ...
    Write-Output "Environment variables set for this session"
}

function UploadSources {
    Write-Output "Uploading source files to Crowdin..."
    crowdin upload sources
}

function UploadTranslations {
    Write-Output "Uploading existing translations to Crowdin..."
    crowdin upload translations
}

function DownloadTranslations {
    Write-Output "Downloading translations from Crowdin..."
    crowdin download
}
