...
public class LangKeys
{
    ...
    public static string OnboardingDeviantArtConnecting = nameof(OnboardingDeviantArtConnecting);
    public static string OnboardingDeviantArtConnectFailed = nameof(OnboardingDeviantArtConnectFailed);
